...
typedef enum BODLVL_enum
{
    ...
    BODLVL_2V7_gc = (0x03<<0),
    BODLVL_3V0_gc = (0x02<<0),
    BODLVL_3V2_gc = (0x01<<0),
    BODLVL_3V5_gc = (0x00<<0),
} BODLVL_t;
...
#define NVM_FUSES_USERID_gm 0xFF
#define NVM_FUSES_USERID_gp 0
#define NVM_FUSES_USERID0_bm (1<<0)
#define NVM_FUSES_USERID0_bp 0
#define NVM_FUSES_USERID1_bm (1<<1)
#define NVM_FUSES_USERID1_bp 1
#define NVM_FUSES_USERID2_bm (1<<2)
#define NVM_FUSES_USERID2_bp 2
#define NVM_FUSES_USERID3_bm (1<<3)
#define NVM_FUSES_USERID3_bp 3
#define NVM_FUSES_USERID4_bm (1<<4)
#define NVM_FUSES_USERID4_bp 4
#define NVM_FUSES_USERID5_bm (1<<5)
#define NVM_FUSES_USERID5_bp 5
#define NVM_FUSES_USERID6_bm (1<<6)
#define NVM_FUSES_USERID6_bp 6
#define NVM_FUSES_USERID7_bm (1<<7)
#define NVM_FUSES_USERID7_bp 7
