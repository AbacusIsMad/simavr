...
{
    EBI_CS_ASPACE_256B_gc = (0x00<<2),
    EBI_CS_ASPACE_512B_gc = (0x01<<2),
    EBI_CS_ASPACE_1KB_gc = (0x02<<2),
    EBI_CS_ASPACE_2KB_gc = (0x03<<2),
    EBI_CS_ASPACE_4KB_gc = (0x04<<2),
    EBI_CS_ASPACE_8KB_gc = (0x05<<2),
    EBI_CS_ASPACE_16KB_gc = (0x06<<2),
    EBI_CS_ASPACE_32KB_gc = (0x07<<2),
    EBI_CS_ASPACE_64KB_gc = (0x08<<2),
    EBI_CS_ASPACE_128KB_gc = (0x09<<2),
    EBI_CS_ASPACE_256KB_gc = (0x0A<<2),
    EBI_CS_ASPACE_512KB_gc = (0x0B<<2),
    EBI_CS_ASPACE_1MB_gc = (0x0C<<2),
    EBI_CS_ASPACE_2MB_gc = (0x0D<<2),
    EBI_CS_ASPACE_4MB_gc = (0x0E<<2),
    EBI_CS_ASPACE_8MB_gc = (0x0F<<2),
    EBI_CS_ASPACE_16M_gc = (0x10<<2),
} EBI_CS_ASPACE_t;
...
{
    PORTCFG_EBIADROUT_PF_gc = (0x00<<2),
    PORTCFG_EBIADROUT_PE_gc = (0x01<<2),
    PORTCFG_EBIADROUT_PFH_gc = (0x02<<2),
    PORTCFG_EBIADROUT_PEH_gc = (0x03<<2),
} PORTCFG_EBIADROUT_t;
typedef enum PORTCFG_EBICSOUT_enum
{
    PORTCFG_EBICSOUT_PH_gc = (0x00<<0),
    PORTCFG_EBICSOUT_PL_gc = (0x01<<0),
    PORTCFG_EBICSOUT_PF_gc = (0x02<<0),
    PORTCFG_EBICSOUT_PE_gc = (0x03<<0),
} PORTCFG_EBICSOUT_t;
...
#define EBI (*(EBI_t *) 0x0440)
#define TWIC (*(TWI_t *) 0x0480)
#define TWID (*(TWI_t *) 0x0490)
#define TWIE (*(TWI_t *) 0x04A0)
#define TWIF (*(TWI_t *) 0x04B0)
...
#define AC_CURRENT_bm 0x80
#define AC_CURRENT_bp 7
...
#define EBI_CS_ASPACE_gm 0x7C
#define EBI_CS_ASPACE_gp 2
#define EBI_CS_ASPACE0_bm (1<<2)
#define EBI_CS_ASPACE0_bp 2
#define EBI_CS_ASPACE1_bm (1<<3)
#define EBI_CS_ASPACE1_bp 3
#define EBI_CS_ASPACE2_bm (1<<4)
#define EBI_CS_ASPACE2_bp 4
#define EBI_CS_ASPACE3_bm (1<<5)
#define EBI_CS_ASPACE3_bp 5
#define EBI_CS_ASPACE4_bm (1<<6)
#define EBI_CS_ASPACE4_bp 6
...
#define EBI_CS_BASEADDR_gm 0xFFF0
#define EBI_CS_BASEADDR_gp 4
#define EBI_CS_BASEADDR0_bm (1<<4)
#define EBI_CS_BASEADDR0_bp 4
#define EBI_CS_BASEADDR1_bm (1<<5)
#define EBI_CS_BASEADDR1_bp 5
#define EBI_CS_BASEADDR2_bm (1<<6)
#define EBI_CS_BASEADDR2_bp 6
#define EBI_CS_BASEADDR3_bm (1<<7)
#define EBI_CS_BASEADDR3_bp 7
#define EBI_CS_BASEADDR4_bm (1<<8)
#define EBI_CS_BASEADDR4_bp 8
#define EBI_CS_BASEADDR5_bm (1<<9)
#define EBI_CS_BASEADDR5_bp 9
#define EBI_CS_BASEADDR6_bm (1<<10)
#define EBI_CS_BASEADDR6_bp 10
#define EBI_CS_BASEADDR7_bm (1<<11)
#define EBI_CS_BASEADDR7_bp 11
#define EBI_CS_BASEADDR8_bm (1<<12)
#define EBI_CS_BASEADDR8_bp 12
#define EBI_CS_BASEADDR9_bm (1<<13)
#define EBI_CS_BASEADDR9_bp 13
#define EBI_CS_BASEADDR10_bm (1<<14)
#define EBI_CS_BASEADDR10_bp 14
#define EBI_CS_BASEADDR11_bm (1<<15)
#define EBI_CS_BASEADDR11_bp 15
...
#define TWID_TWIS_vect _VECTOR(75)
#define TWID_TWIM_vect_num 76
#define TWID_TWIM_vect _VECTOR(76)
...
#define PORTQ_INT0_vect _VECTOR(94)
#define PORTQ_INT1_vect_num 95
#define PORTQ_INT1_vect _VECTOR(95)
#define PORTH_INT0_vect_num 96
#define PORTH_INT0_vect _VECTOR(96)
#define PORTH_INT1_vect_num 97
#define PORTH_INT1_vect _VECTOR(97)
#define PORTJ_INT0_vect_num 98
#define PORTJ_INT0_vect _VECTOR(98)
#define PORTJ_INT1_vect_num 99
#define PORTJ_INT1_vect _VECTOR(99)
#define PORTK_INT0_vect_num 100
#define PORTK_INT0_vect _VECTOR(100)
#define PORTK_INT1_vect_num 101
#define PORTK_INT1_vect _VECTOR(101)
...
#define TWIF_TWIS_vect _VECTOR(106)
#define TWIF_TWIM_vect_num 107
#define TWIF_TWIM_vect _VECTOR(107)
...
#define TCF1_OVF_vect _VECTOR(114)
#define TCF1_ERR_vect_num 115
#define TCF1_ERR_vect _VECTOR(115)
#define TCF1_CCA_vect_num 116
#define TCF1_CCA_vect _VECTOR(116)
#define TCF1_CCB_vect_num 117
#define TCF1_CCB_vect _VECTOR(117)
#define SPIF_INT_vect_num 118
#define SPIF_INT_vect _VECTOR(118)
...
#define USARTF1_RXC_vect _VECTOR(122)
