...
#stop from optimising sections out
AVR_CFLAGS = -O0 -gdwarf-2 -Wall $(ARCH_FLAGS) -Wl,--relax -ffunction-sections -fdata-sections -Wl,--undefined=_mmcu,--section-start=.mmcu=0x910000
...
data: main.c vars.S
	$(AVR_CC) -nostdinc $(AVR_CFLAGS) -Os $^ -o main.elf $(AVR_PKGS)
